...
# python3 main.py -test 001 -n 1000 -x 1.0 -r_ini 0.1 -r_fin 0.1 -radius_add 0.05 -num_graph 20 

# Test 2: Radius evolution, vemos la evolución del multicapa dados dos radios en un intervalo, con secuencias de radius_add
  python3 main.py -test 010 -n 1000 -x 1.0 -r_ini 0.1 -r_fin 0.2 -radius_add 0.005 -num_graph 20

# Test 3: Multilayer evolution, vemos gráficamente el multicapa añadiendo poco a poco las capas, en intervalos
# python3 main.py -test 100 -n 1000 -x 1.0 -r_ini 0.01 -r_fin 0.1 -radius_add 0.05 -num_graph 20
